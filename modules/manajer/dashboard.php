        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">Selamat Datang di Aplikasi PT. INTIBOGA MANDIRI ADMIN</h2>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-xl-6 col-xxl-3 col-md-6 col-12">
                            <div class="card custom-card">
                                <div class="card-body pb-3">
                                    <h5 class="fs-14">Laporan Penjualan</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6 col-xxl-3 col-md-6 col-12">
                            <div class="card custom-card">
                                <div class="card-body pb-3">
                                    <h5 class="fs-14">Laporan Kinerja Sales</h5>
                                </div>
                            </div>
                        </div>
