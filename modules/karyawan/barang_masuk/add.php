...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $id_manager = $_POST['id_manager']; // Mengambil id_manager dari form

    // Menyimpan data ke dalam tabel brg_msk
    $stmt = $conn->prepare("INSERT INTO brg_msk (catatan, id_pesan, id_manager) VALUES (?, ?, ?)");
    $stmt->bind_param("sii", $catatan, $id_pesan, $id_manager);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan.'); window.location.href='data_barang_masuk.php';</script>";
    } else {
        echo "<script>alert('Terjadi kesalahan: " . $stmt->error . "'); window.location.href='barang_masuk.php';</script>";
    }
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Halaman Form Barang Masuk</li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <!-- ID Pesan -->
                                                <div class="col-md-6 col-xl-6 col-xxl-6 mb-3">
                                                    <label for="id_pesan" class="form-label">Pilih Nama Barang</label>
                                                    <select id="id_pesan" name="id_pesan" class="form-control" required>
                                                        <option value="">Pilih Nama Barang</option>
                                                        <?php foreach ($barangList as $barang): ?>
                                                            <option value="<?php echo htmlspecialchars($barang['id_pesan']); ?>">
                                                                <?php echo htmlspecialchars($barang['nm_brg']); ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-xl-6 col-xxl-6 mb-3">
                                                    ...
                                                    <textarea name="catatan" id="catatan" rows="2" class="form-control" required></textarea><br><br>
                                                </div>
