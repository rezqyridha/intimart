...
include '../config.php';
// Query untuk mengambil data stok_sistem yang telah disimpan
$query = "
                SELECT ss.id_stok_sistem, ss.selisih, sf.nm_brg, sf.kode_brg, sf.jml_fisik, sp.saldo_akhir
                FROM stok_sistem ss
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Halaman Data Selisih Stok Fisik & Sistem</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    <div class="card-title">
                                        Data Selisih Stok Fisik & Sistem
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="pegawai" class="table text-nowrap table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    // Tombol Edit
                                                    echo "<a href='edit-stok-sistem.php?id_stok_sistem=" . $row['id_stok_sistem'] . "' class='btn btn-primary shadow btn-xs sharp mr-1'>";
                                                    echo "<i class='fa fa-pencil'></i>";
                                                    echo "</a>";

                                                    // Tombol Hapus
                                                    echo "<a href='del-stok-sistem.php?id_stok_sistem=" . $row['id_stok_sistem'] . "' class='btn btn-danger shadow btn-xs sharp' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>";
                                                    echo "<i class='fa fa-trash'></i>";
                                                    echo "</a>";

                                                    // Tombol Print
                                                    echo "<a href='print-stok-sistem.php?id_stok_sistem=" . $row['id_stok_sistem'] . "' class='btn btn-info shadow btn-xs sharp'>";
