...
// Query untuk mengambil data dari tabel arus_kas yang berelasi dengan tabel penjualan dan laba_bersih
$query = "
SELECT ak.id_arus_kas, p.nm_brg, p.tgl, p.total_penjualan, lb.total_biaya, ak.saldo_kas, m.nm_manager, m.jabatan
FROM arus_kas ak
JOIN penjualan p ON ak.id_penjualan = p.id_penjualan
JOIN laba_bersih lb ON ak.id_laba_bersih = lb.id_laba_bersih
JOIN manager m ON ak.id_manager = m.id_manager
";
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Halaman Data Arus Kas</li>
                        </ol>
                    </div>
                </div>
                                                ...
                                                <?php if ($result->num_rows > 0): ?>
                                                    ...
                                                    <?php while ($row = $result->fetch_assoc()): ?>
                                                        <tr>
                                                            ...
                                                            <td>Rp <?php echo number_format($row['saldo_kas'], 0, ',', '.'); ?></td>
                                                            <td>
                                                                <!-- Tombol Edit -->
                                                                <a href="edit-arus-kas.php?id_arus_kas=<?php echo $row['id_arus_kas']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>

                                                                <!-- Tombol Hapus -->
                                                                <a href="del-arus-kas.php?id_arus_kas=<?php echo $row['id_arus_kas']; ?>" class="btn btn-danger shadow btn-xs sharp" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                                                    <i class="fa fa-trash"></i>
                                                                </a>

                                                                <!-- Tombol Print -->
                                                                <a href="print-arus-kas.php?id_arus_kas=<?php echo $row['id_arus_kas']; ?>" class="btn btn-success shadow btn-xs sharp">
